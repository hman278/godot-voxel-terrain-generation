...
func _process(delta):
	...
	var obj_in_frame = str(Performance.get_monitor(Performance.RENDER_TOTAL_OBJECTS_IN_FRAME))
	var draw_calls = str(Performance.get_monitor(Performance.RENDER_TOTAL_DRAW_CALLS_IN_FRAME))
